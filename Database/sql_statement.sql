...
ALTER TABLE POS
ADD PROJECT_ID UNIQUEIDENTIFIER, UNIQUEIDENTIFIER
	
	REVIEWED_BY_ID UNIQUEIDENTIFIER,
	APPROVERD_BY_ID UNIQUEIDENTIFIER,
ALTER TABLE POS
ADD CONSTRAINT FK_POS_PROJECTS FOREIGN KEY (PROJECT_ID) REFERENCES PROJECTS(ID)
...
ALTER TABLE POS
ADD APPROVED_BY_ID UNIQUEIDENTIFIER
	
	REVIEW_BY_ID UNIQUEIDENTIFIER,
	AGREMENT_BY_ID UNIQUEIDENTIFIER,
...
('{0}', '{1}', '{2}', '{3}', N'{4}', N'{5}', N'{6}', N'{7}', '{8}', '{9}', '{10}', '{11}')
SET DATEFORMAT DMY INSERT INTO MPRS (ID, MPR_NO, MPR_REV_TOTAL, MPR_CREATE_DATE, MPR_EXPECTED_DELIVERY_DATE, MPR_PREPARED, MPR_REVIEWED, MPR_APPROVED, IS_MAKE_PO, STAFF_ID, PROJECT_ID) VALUES ('{0}', '{1}', '{2}', N'{3}', N'{4}', N'{5}', N'{6}', N'{7}', '{8}', '{9}', '{10}')
...
SET DATEFORMAT DMY INSERT INTO MPRS (ID, MPR_NO, MPR_REV_TOTAL, MPR_CREATE_DATE, MPR_EXPECTED_DELIVERY_DATE, MPR_PREPARED, MPR_REVIEWED, MPR_APPROVED, IS_MAKE_PO, STAFF_ID, PROJECT_ID)
VALUES ('24bf3e49-8f15-492b-bb67-8093cacefb1b', 'MPR-TEST-001', '', N'07/01/2026 12:00:00 AM', N'07/01/2026 12:00:00 AM', N'ADMINISTRATOR', N'Administrator', N'David Hoang', 'False', 'False', '3ad699a8-6c51-411f-a750-a94c84b7e7e7')
