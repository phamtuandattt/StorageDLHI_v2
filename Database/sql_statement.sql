...
UNIT_ID) 
VALUES 
('e3f1ad75-9973-4227-9ad1-eb9a68e23063',
N'Plate', 
'DOPL00210010086_1200_T', 
'DOPL00010010086_1200',
'Non-standard',
N'C:\Users\TUAN DAT\Desktop\Chú Thành\flowersandkisseshomepage.jpg',
(SELECT *FROM OPENROWSET(BULK N'C:\Users\TUAN DAT\Desktop\Chú Thành\flowersandkisseshomepage.jpg', SINGLE_BLOB) AS IMAGE), 
'100', '', '100', '8', '6', '1200', '', '', N'78287175-3b60-4217-8dbf-f78fe8933011')

ALTER TABLE PRODUCTS
ADD STANDARD_ID UNIQUEIDENTIFIER
...
ALTER TABLE MPR_DETAIL
ALTER COLUMN MPR_QTY BIGINT;
