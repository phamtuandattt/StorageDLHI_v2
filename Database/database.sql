...
(
	...
	CONSTRAINT FK_PROJECT_CUSTOMER FOREIGN KEY (CUSTOMERS_ID) REFERENCES CUSTOMERS(ID),
)
...
-- TABLE MONEY CALCULATE FORMULA
CREATE TABLE MONEY_CALCULATE_FORMULA (
	ID UNIQUEIDENTIFIER NOT NULL,
	FORMULA_TEXT NVARCHAR(100),
	FORMULA_CALCULATE NVARCHAR(100),
	FORMULA_PARAS NVARCHAR(100),

	CONSTRAINT PK_MONEY_CALCULATE_FORMULA PRIMARY KEY (ID)
)
...
CREATE TABLE FORMULA_PARAMETERS (
	...
	PARA_VALUE FLOAT,
	PARA_DESCRIPTION NVARCHAR(100),

	CONSTRAINT PK_FORMULA_PARAMETERS PRIMARY KEY(ID)
)
...
CREATE TABLE STAFFS (
	...
	STAFF_DEVICE_NAME NVARCHAR(100),
...
CREATE TABLE MATERIAL_TYPES ( --MAIN, PLATE, V-BEAM, PIPE,.v.v..
	ID UNIQUEIDENTIFIER NOT NULL,
	TYPE_CODE CHAR(5),
...
CREATE TABLE MATERIAL_TYPE_DETAIL ( -- MAIN: PLATE, STEEL,..v.v..; FITTING: FF00, FC00,..v.v..; 
	ID UNIQUEIDENTIFIER NOT NULL,
	MATERIAL_TYPE_CODE NVARCHAR(50),
	MATERIAL_TYPE_NAME NVARCHAR(100),
	
	MATERIAL_TYPES_ID UNIQUEIDENTIFIER,

	CONSTRAINT PK_MATERIAL_SOURCE PRIMARY KEY (ID),
	CONSTRAINT FK_MATERIAL_TYPE_DETAIL_MATERIAL_TYPES FOREIGN KEY (MATERIAL_TYPES_ID) REFERENCES MATERIAL_TYPES(ID)
)

CREATE TABLE MATERIAL_TYPE_DETAIL_ITEM ( -- PLATE: PL00-001, PL01-002,.v.v..; PIPE: PI00-001; PI00-002,..v... 
	ID UNIQUEIDENTIFIER NOT NULL,
	ITEM_NUMBER NVARCHAR(50),
	ITEM_NAME NVARCHAR(100),
	
	ITEM_TYPE UNIQUEIDENTIFIER, -- is MATERIAL_TYPE_DETAL_ID

	CONSTRAINT PK_MATERIAL_TYPE_DETAIL_ITEM PRIMARY KEY (ID),
	CONSTRAINT FK_MATERIAL_TYPE_DETAIL_ITEM_MATERIAL_TYPE_DETAIL FOREIGN KEY (ITEM_TYPE) REFERENCES MATERIAL_TYPE_DETAIL(ID)
)
...
CREATE TABLE PRODUCTS (
	...
	PRODUCT_CODE CHAR(20), -- ORGIRIN(2) + TYPES_CODE(7) + STANDARD_CODE(3) + SIZE (...)
	...
	MATERIAL_OF_TYPE UNIQUEIDENTIFIER,
	ITEM_TYPE UNIQUEIDENTIFIER,
	...
	CONSTRAINT FK_PRODUCTS_TYPES FOREIGN KEY (TYPE_ID) REFERENCES MATERIAL_TYPES(ID),
	CONSTRAINT FK_PRODUCTS_MATERIAL_OF_TYPES FOREIGN KEY (MATERIAL_OF_TYPE) REFERENCES MATERIAL_TYPE_DETAIL(ID),
	CONSTRAINT FK_PRODUCTS_ITEM_OF_MATERIAL_TYPES FOREIGN KEY (ITEM_TYPE) REFERENCES MATERIAL_TYPE_DETAIL_ITEM(ID),
)
...
CREATE TABLE POS (
	...
	CONSTRAINT FK_POS_PROJECTS FOREIGN KEY (PROJECT_ID) REFERENCES PROJECTS(ID),
)
...
CREATE TABLE IMPORT_PRODUCTS (
	...
	CONSTRAINT FK_IMPORT_PRODUCTS_PROJECTS FOREIGN KEY (PROJECT_ID) REFERENCES PROJECTS(ID),
)
...
CREATE TABLE DELIVERY_PRODUCTS (
	...
	FROM_WAREHOUSE_ID UNIQUEIDENTIFIER,
	STAFF_ID UNIQUEIDENTIFIER,
	...
	CONSTRAINT FK_DELIVERY_PRODUCTS_FROM_WAREHOUSE FOREIGN KEY (FROM_WAREHOUSE_ID) REFERENCES WAREHOUSES(ID),
)
...
CREATE TABLE DELIVERY_PRODUCT_DETAIL (
	...
	PRODUCT_ID UNIQUEIDENTIFIER NOT NULL,
	TO_WAREHOUSE_ID UNIQUEIDENTIFIER,
	QTY INT,
	...
	CONSTRAINT FK_DELIVERY_PRODUCTS_TO_WAREHOUSE FOREIGN KEY (TO_WAREHOUSE_ID) REFERENCES WAREHOUSES(ID),
)
