...
END
GO
EXEC GET_PO_DETAIL 'FD9BF743-7F09-499A-B0ED-33CA34733D65'
...
BEGIN
    ...
    WHERE PO_DETAIL.PO_PRODUCT_ID = PRODUCTS.ID
        ...
        AND PO_DETAIL.PO_ID = @PO_ID
END
EXEC GET_PO_DETAIL_FOR_IMPORT 'FD9BF743-7F09-499A-B0ED-33CA34733D65'
...
END
EXEC GET_NUMBER_OF_MPR_CREATED 'PJ-004'
...
END
EXEC GET_LIST_STAFFS_OF_DEPARMENT 'BE79D498-E0F5-46CE-8CE4-F3E71C19774C'
