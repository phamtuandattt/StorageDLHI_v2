...
namespace StorageDLHI.DAL.QueryStatements
{
    public class QueryStatement
    {
        ...
        public const string ADD_MPR_V2 = "  SET DATEFORMAT DMY INSERT INTO MPRS (ID, MPR_NO, MPR_REV_TOTAL, MPR_CREATE_DATE, MPR_EXPECTED_DELIVERY_DATE, MPR_PREPARED, MPR_REVIEWED, MPR_APPROVED, IS_MAKE_PO, STAFF_ID, PROJECT_ID, IS_CANCEL, CANCEL_BY) VALUES ('{0}', '{1}', '{2}', N'{3}', N'{4}', N'{5}', N'{6}', N'{7}', '{8}', '{9}', '{10}', '{11}', N'{12}')";
