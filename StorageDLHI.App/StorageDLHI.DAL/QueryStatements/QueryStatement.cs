...
namespace StorageDLHI.DAL.QueryStatements
{
    public class QueryStatement
    {
        ...
        public const string PROPERTY_SEARCH_MATERIAL_TYPE_CODE = "MATERIAL_TYPE_CODE";
        public const string PROPERTY_SEARCH_MATERIAL_TYPE_DETAIL_CODE = "MATERIAL_TYPE_DETAIL_CODE";
        ...
        public const string ADD_MPR_V2 = "SET DATEFORMAT DMY INSERT INTO MPRS (ID, MPR_NO, MPR_REV_TOTAL, MPR_CREATE_DATE, MPR_EXPECTED_DELIVERY_DATE, MPR_PREPARED, MPR_REVIEWED, MPR_APPROVED, IS_MAKE_PO, STAFF_ID, PROJECT_ID, IS_CANCEL, CANCEL_BY, REVIEWED_BY_ID, APPROVERD_BY_ID) VALUES ('{0}', '{1}', '{2}', N'{3}', N'{4}', N'{5}', N'{6}', N'{7}', '{8}', '{9}', '{10}', '{11}', N'{12}', '{13}', '{14}')";
        ...
        public const string UPDATE_MPR_INFO = "SET DATEFORMAT DMY UPDATE MPRS SET MPR_EXPECTED_DELIVERY_DATE = '{0}', MPR_REVIEWED = N'{1}', MPR_APPROVED = N'{2}', REVIEWED_BY_ID = '{3}', APPROVERD_BY_ID = '{4}' WHERE ID = '{5}'";
        ...
        public const string PROPERTY_MPR_MPR_WO_NO = "WO_NO";
        public const string PROPERTY_MPR_MPR_PROJECT_NAME = "PROJECT_NAME";
        ...
        public const string UPDATE_USER_LOGIN = "UPDATE STAFFS SET STAFF_NAME = N'{0}', DEPARMENT_ID = '{1}', STAFF_ROLE_ID = '{2}' WHERE ID = '{3}'";
